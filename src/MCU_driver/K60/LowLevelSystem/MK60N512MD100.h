...
struct ADC_Type
{
	...
	struct
	{
		...
		unsigned ADLPC		: 1;
		unsigned			: 24;
	} __IO CFG1;                              /*!< ADC configuration register 1, offset: 0x8 */
	struct
	{
		unsigned ADLSTS		: 2;
		unsigned ADHSC		: 1;
		...
		unsigned MUXSEL		: 1;
		unsigned			: 27;
	} __IO CFG2;                              /*!< Configuration register 2, offset: 0xC */
	__I  uint32_t R[2];                              /*!< ADC data result register, array offset: 0x10, array step: 0x4 */
	__IO uint32_t CV1;                               /*!< Compare value registers, offset: 0x18 */
	__IO uint32_t CV2;                               /*!< Compare value registers, offset: 0x1C */
	struct
	{
		...
		unsigned ADACT		: 1;
		unsigned			: 24;
	} __IO SC2;                               /*!< Status and control register 2, offset: 0x20 */
	struct
	{
		unsigned AVGS		: 2;
		unsigned AVGE		: 1;
		...
		unsigned CAL		: 1;
		unsigned			: 24;
	} __IO SC3;                               /*!< Status and control register 3, offset: 0x24 */
	__IO uint32_t OFS;                               /*!< ADC offset correction register, offset: 0x28 */
	__IO uint32_t PG;                                /*!< ADC plus-side gain register, offset: 0x2C */
	__IO uint32_t MG;                                /*!< ADC minus-side gain register, offset: 0x30 */
	__IO uint32_t CLPD;                              /*!< ADC plus-side general calibration value register, offset: 0x34 */
...
struct DMA_Type
{
	struct 
	{
		...
		unsigned CX		: 1;
		unsigned		: 14;
	} __IO CR;                                /*!< Control Register, offset: 0x0 */
	struct 
	{
		unsigned DBE	: 1;
		unsigned SBE	: 1;
		...
		unsigned		: 14;
		unsigned VLD	: 1;
	} __I ES;                                /*!< Error Status Register, offset: 0x4 */
	     uint8_t RESERVED_0[4];
	__IO uint32_t ERQ;                               /*!< Enable Request Register, offset: 0xC */
	     uint8_t RESERVED_1[4];
	__IO uint32_t EEI;                               /*!< Enable Error Interrupt Register, offset: 0x14 */
	...
	struct
	{
		unsigned CEEI		: 4;		/*!< Clear Enable Error Interrupt Register, offset: 0x18 */
		unsigned			: 2;
		unsigned CAEE		: 1;
		unsigned CEEI_NOP	: 1;

		unsigned SEEI		: 4;		/*!< Set Enable Error Interrupt Register, offset: 0x19 */
		unsigned			: 2;
		unsigned SAEE		: 1;
		unsigned SEEI_NOP	: 1;

		unsigned CERQ		: 4;		/*!< Clear Enable Request Register, offset: 0x1A */
		unsigned			: 2;
		unsigned CAER		: 1;
		unsigned CERQ_NOP	: 1;

		unsigned SERQ		: 4;		/*!< Set Enable Request Register, offset: 0x1B */
		unsigned			: 2;
		unsigned SAER		: 1;
		unsigned SERQ_NOP	: 1;

		unsigned CDNE		: 4;		/*!< Clear DONE Status Bit Register, offset: 0x1C */
		unsigned			: 2;
		unsigned CADN		: 1;
		unsigned CDNE_NOP	: 1;

		unsigned SSRT		: 4;		/*!< Set START Bit Register, offset: 0x1D */
		unsigned			: 2;
		unsigned SAST		: 1;
		unsigned SSRT_NOP	: 1;

		unsigned CERR		: 4;		/*!< Clear Error Register, offset: 0x1E */
		unsigned			: 2;
		unsigned CAEI		: 1;
		unsigned CERR_NOP	: 1;

		unsigned CINT		: 4;		/*!< Clear Interrupt Request Register, offset: 0x1F */
		unsigned			: 2;
		unsigned CAIR		: 1;
		unsigned CINT_NOP	: 1;
	...
	{                                         /* offset: 0x1000, array step: 0x20 */
		...
		union
		{
			...
			struct  
			{
				unsigned		: 16;				/* 这是预留给SOFF的位置，为了必须4字节对齐 */
				unsigned DSIZE	: 3;
				unsigned DMOD	: 5;
				unsigned SSIZE	: 3;
				unsigned SMOD	: 5;
			} __IO ATTR;							/*!< TCD Transfer Attributes, array offset: 0x1006, array step: 0x20 */
		};
		...
		{                                          /* offset: 0x1008, array step: 0x20 */
			...
			struct  
			{
				...
				unsigned DMLOE	: 1;
				unsigned SMLOE	: 1;
			} __IO NBYTES_MLOFFNO;                    /*!< TCD Signed Minor Loop Offset (Minor Loop Enabled and Offset Disabled), array offset: 0x1008, array step: 0x20 */
			struct  
			{
				unsigned NBYTES	: 10;
				unsigned MLOFF	: 20;
				unsigned DMLOE	: 1;
				unsigned SMLOE	: 1;
			} __IO NBYTES_MLOFFYES;                   /*!< TCD Signed Minor Loop Offset (Minor Loop and Offset Enabled), array offset: 0x1008, array step: 0x20 */
		};
		__IO uint32_t SLAST;                             /*!< TCD Last Source Address Adjustment, array offset: 0x100C, array step: 0x20 */
		__IO uint32_t DADDR;                             /*!< TCD Destination Address, array offset: 0x1010, array step: 0x20 */
		...
		{                                          /* offset: 0x1016, array step: 0x20 */
			...
			struct  
			{
				unsigned		: 16;				/* 这是预留给DOFF的位置，为了必须4字节对齐 */
				unsigned CITER	: 9;
				unsigned LINKCH	: 4;
				unsigned		: 2;
				unsigned ELINK	: 1;
			} __IO CITER_ELINKYES;					/*!< TCD Current Minor Loop Link, Major Loop Count (Channel Linking Enabled), array offset: 0x1016, array step: 0x20 */
			struct  
			{
				unsigned		: 16;				/* 这是预留给DOFF的位置，为了必须4字节对齐 */
				unsigned CITER	: 15;
				unsigned ELINK	: 1;
			} __IO CITER_ELINKNO;					/*!< TCD Current Minor Loop Link, Major Loop Count (Channel Linking Disabled), array offset: 0x1016, array step: 0x20 */
		};
		__IO uint32_t DLAST_SGA;					/*!< TCD Last Destination Address Adjustment/Scatter Gather Address, array offset: 0x1018, array step: 0x20 */
		union 
		{											/* offset: 0x101E, array step: 0x20 */
			struct
			{
				...
				unsigned				: 2;
				unsigned BWC			: 2;
			} __IO CSR;								/*!< TCD Control and Status, array offset: 0x101C, array step: 0x20 */
			struct
			{
				unsigned		: 16;				/* 这是预留给CSR的位置，为了必须4字节对齐 */
				unsigned BITER	: 15;
				unsigned ELINK	: 1;
			} __IO BITER_ELINKNO;					/*!< TCD Beginning Minor Loop Link, Major Loop Count (Channel Linking Disabled), array offset: 0x101E, array step: 0x20 */
			struct
			{
				unsigned		: 16;				/* 这是预留给CSR的位置，为了必须4字节对齐 */
				unsigned BITER	: 9;
				...
				unsigned		: 2;
				unsigned ELINK	: 1;
			} __IO BITER_ELINKYES;                    /*!< TCD Beginning Minor Loop Link, Major Loop Count (Channel Linking Enabled), array offset: 0x101E, array step: 0x20 */
		};
	} TCD[16];
};
...
typedef struct 
{
	struct  
	{
		...
		unsigned TOF	: 1;
		unsigned		: 24;		
	} __IO SC;                                /*!< Status and Control, offset: 0x0 */
	__IO uint32_t CNT;                               /*!< Counter, offset: 0x4 */
	__IO uint32_t MOD;                               /*!< Modulo, offset: 0x8 */
	struct 
	{                                         /* offset: 0xC, array step: 0x8 */
		struct  
		{
			...
			unsigned CHF	: 1;
			unsigned		: 24;		
		} __IO CnSC;                              /*!< Channel (n) Status and Control, array offset: 0xC, array step: 0x8 */
		__IO uint32_t CnV;                               /*!< Channel (n) Value, array offset: 0x10, array step: 0x8 */
	} CONTROLS[8];
	__IO uint32_t CNTIN;                             /*!< Counter Initial Value, offset: 0x4C */
	__I  uint32_t STATUS;                            /*!< Capture and Compare Status, offset: 0x50 */
	struct  
	{
		...
		unsigned FAULTIE	: 1;
		unsigned			: 24;	
	} __IO MODE;                              /*!< Features Mode Selection, offset: 0x54 */
	struct  
	{
		unsigned CNTMIN		: 1;
		unsigned CNTMAX		: 1;
		...
		unsigned SWSYNC		: 1;
		unsigned			: 24;	
	} __IO SYNC;                              /*!< Synchronization, offset: 0x58 */
	__IO uint32_t OUTINIT;                           /*!< Initial State for Channels Output, offset: 0x5C */
	__IO uint32_t OUTMASK;                           /*!< Output Mask, offset: 0x60 */
	__IO uint32_t COMBINE;                           /*!< Function for Linked Channels, offset: 0x64 */
	struct  
	{
		...
		unsigned DTPS		: 2;
		unsigned			: 24;
	} __IO DEADTIME;                          /*!< Deadtime Insertion Control, offset: 0x68 */
	struct  
	{
		unsigned CH2TRIG	: 1;
		unsigned CH3TRIG	: 1;
		...
		unsigned TRIGF		: 1;
		unsigned			: 24;	
	} __IO EXTTRIG;                           /*!< FTM External Trigger, offset: 0x6C */
	__IO uint32_t POL;                               /*!< Channels Polarity, offset: 0x70 */
	struct  
	{
		unsigned FAULTF0	: 1;
		...
		unsigned FAULTF		: 1;
		unsigned			: 24;		
	} __IO FMS;                               /*!< Fault Mode Status, offset: 0x74 */
	struct  
	{
		unsigned CH0FVAL	: 4;
		unsigned CH1FVAL	: 4;
		...
		unsigned CH3FVAL	: 4;
		unsigned			: 16;	
	} __IO FILTER;                            /*!< Input Capture Filter Control, offset: 0x78 */
	struct  
	{
		unsigned FAULT0EN	: 1;
		unsigned FAULT1EN	: 1;
		...
		unsigned FFVAL		: 4;
		unsigned			: 20;		
	} __IO FLTCTRL;                           /*!< Fault Control, offset: 0x7C */
	struct  
	{
		unsigned QUADEN		: 1;
		unsigned TOFDIR		: 1;
		...
		unsigned			: 24;		
	} __IO QDCTRL;                            /*!< Quadrature Decoder Control and Status, offset: 0x80 */
	struct  
	{
		unsigned NUMTOF		: 5;
		unsigned			: 1;
		...
		unsigned GTBEOUT	: 1;
		unsigned			: 21;		
	} __IO CONF;                              /*!< Configuration, offset: 0x84 */
	__IO uint32_t FLTPOL;                            /*!< FTM Fault Input Polarity, offset: 0x88 */
	struct  
	{
		...
		unsigned HWSOC		: 1;
		unsigned			: 11;			
	} __IO SYNCONF;                           /*!< Synchronization Configuration, offset: 0x8C */
	__IO uint32_t INVCTRL;                           /*!< FTM Inverting Control, offset: 0x90 */
	__IO uint32_t SWOCTRL;                           /*!< FTM Software Output Control, offset: 0x94 */
	struct  
	{
		...
		unsigned LDOK		: 1;
		unsigned			: 22;		
	} __IO PWMLOAD;                           /*!< FTM PWM Load, offset: 0x98 */
} FTM_Type;
...
typedef struct 
{
	union
	{
		struct 
		{
			...
			unsigned TCF		: 1;
			unsigned			: 24;
		} __IO CSR;							 /*!< Low Power Timer Control Status Register, offset: 0x0 */
		uint32_t wCSR;
	};
	...
	struct 
	{
		...
		unsigned PRESCALE	: 4;
		unsigned			: 25;
	} __IO PSR;                               /*!< Low Power Timer Prescale Register, offset: 0x4 */
	__IO uint32_t CMR;                               /*!< Low Power Timer Compare Register, offset: 0x8 */
	__I  uint32_t CNR;                               /*!< Low Power Timer Counter Register, offset: 0xC */
} LPTMR_Type;
...
typedef struct 
{
	...
	struct
	{
		...
		unsigned ISF	: 1;
		unsigned		: 7;
	} __IO PCR[32];									/*!< Pin Control Register n, array offset: 0x0, array step: 0x4 */
...
struct SPI_Type
{
	struct
	{
		...
		unsigned			: 2;
		unsigned ROOE		: 1;
		unsigned PCSSE		: 1;	// current unused
		unsigned MTFE		: 1;
		unsigned FRZ		: 1;
		unsigned DCONF		: 2;
		unsigned CONT_SCKE	: 1;
		unsigned MSTR		: 1;
	} __IO MCR;										/*!< DSPI Module Configuration Register, offset: 0x0 */
		 uint8_t RESERVED_0[4];
		 uint16_t RESERVED_01;
	__IO uint16_t TCR;								/*!< DSPI Transfer Count Register, offset: 0x8 */
	union 
	{                                          /* offset: 0xC */
		struct  
		{
			...
			unsigned FMSZ		: 4;
			unsigned DBR		: 1;
		} __IO CTAR[2];                           /*!< DSPI Clock and Transfer Attributes Register (In Master Mode), array offset: 0xC, array step: 0x4 */
		struct
		{
			unsigned			: 25;
			unsigned CPHA		: 1;
			unsigned CPOL		: 1;
			unsigned FMSZ		: 5;
		} __IO CTAR_SLAVE[1];                     /*!< DSPI Clock and Transfer Attributes Register (In Slave Mode), array offset: 0xC, array step: 0x4 */
	};
		 uint8_t RESERVED_1[24];
	struct
	{
		...
		unsigned TXRXS		: 1;
		unsigned TCF		: 1;
	} __IO SR;                                /*!< DSPI Status Register, offset: 0x2C */
	struct
	{
		unsigned			: 16;
		...
		unsigned			: 1;
		unsigned TCF_RE		: 1;
	} __IO RSER;                              /*!< DSPI DMA/Interrupt Request Select and Enable Register, offset: 0x30 */
	union 
	{                                          /* offset: 0x34 */
		__IO uint32_t PUSHR_W;					// 写入整个PUSHR时写此变量
		struct
		{
			...
			unsigned CTAS		: 3;
			unsigned CONT		: 1;
		} __IO PUSHR;                             /*!< DSPI PUSH TX FIFO Register In Master Mode, offset: 0x34 */
		struct
		{
			__IO uint16_t TXDATA;
			unsigned			: 16;
		} __IO PUSHR_SLAVE;                       /*!< DSPI PUSH TX FIFO Register In Slave Mode, offset: 0x34 */
	};
	__I  uint32_t POPR;                              /*!< DSPI POP RX FIFO Register, offset: 0x38 */
	struct
	{
		__I uint16_t TXDATA;
		__I uint16_t TXCMD_TXDATA;
	} __I TXFR[4];                             /*!< DSPI Transmit FIFO Registers, offset: 0x3C */
		 uint8_t RESERVED_2[48];
